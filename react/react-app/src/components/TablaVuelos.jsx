...
import GroupedBar from "../components/Graph";
import Button from '@material-ui/core/Button'
import { GraphRadar } from "../components/GraphRadar";
import { GraphLine } from "../components/GraphLine";
import axios from "axios";
import Grid from "@material-ui/core/Grid";
import Mapaleaf from "../components/Mapa";
...
import pasaGrafico from "../components/General";
      ...
      >
        ...
        {numSelected > 0 ? (
          <Tooltip title="Generar PDF">
            <Link to={"/vistaprevia/"+props.seleccionados.join(",")}>
